...
class MakeASchedule extends StatelessWidget {

  String nameSchedule = 'Name of Schedule';

  MakeASchedule({Key key, @required this.nameSchedule}) : super(key: key);
      ...
      child: Container(
        ...
        child: TextField(
          ...
          decoration: new InputDecoration(
              icon: Icon(Icons.monetization_on, color: Colors.green, size: 25),
              hintText: "Money",
              suffixText: '\$',
  ...
  Widget NameSchedule(BuildContext context, EventSchedule eventSchedule) {
    eventSchedule.nameSchedule = nameSchedule;
    return Container(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ListTile(
              leading: Icon(Icons.dynamic_feed, color: Colors.lightBlueAccent[400],),
              title: Container(
                padding: EdgeInsets.only(left: 5),
                child: Text(eventSchedule.nameSchedule, style: TextStyle(fontSize: 17),),
              ),
              onTap: () {
                print('hello');
              },
    ...
    return Container(
      child: Column(
        children: [
          ...
          NameSchedule(context, eventSchedule),
        ],
      ),
    );
  }
                    ...
                    actions: [
                      FlatButton(
                        ...
                        onPressed: () async {
                          ...
                          if (eventSchedule.checkCanSave(eventSchedule) == 1) {
                            ...
                            if (sumCurrentMoney - moneyAMonth <= 0) {
                              ...
                              print("dong 209 class SChedule sumCurrentMoney = $sumCurrentMoney");
                              ...
                              eventSchedule.SaveSchedule(context, eventSchedule, eventSchedule.nameSchedule);
                              currentFocus.unfocus();
                            }
                          }
                          else {
